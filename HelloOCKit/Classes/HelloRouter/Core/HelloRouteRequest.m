...
@interface HelloRouteRequest ()
@property (nonatomic, strong, readonly, nullable) NSURL *originalURL;
@end

@implementation HelloRouteRequest
- (nullable instancetype)initWithPath:(NSString *)rq parameters:(nullable HelloParameters)prts {
#ifdef DEBUG
...
- (instancetype)_initWithPath:(nullable NSString *)rq parameters:(nullable HelloParameters)prts {
    self = [super init];
    if ( self ) {
...
- (nullable instancetype)initWithURL:(NSURL *)URL {
    ...
    HelloParameters parameters = nil;
